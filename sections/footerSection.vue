<template>
    ...
    <footer class="flex justify-between items-center px-16 py-8 bg-neutral-300 dark:bg-neutral-900">
        <span class="dark:text-indigo-50">© 2020-2023 <span class="hom"> - Nyronium Network Group</span></span>
        <div class="flex gap-6">
            <a href="https://discord.nyronium.com">
                <svg class="w-8 h-8 text-neutral-950 dark:text-indigo-50" fill="currentColor"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <a href="https://github.com/nyronium/web">
                <svg class="w-8 h-8 text-neutral-950 dark:text-indigo-50" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
